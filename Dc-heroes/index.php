...
<head>
	<meta charset="utf-8" />
	<meta name="description" content="Dc Univserse">
...
<body>
	<header>
  <img src="images/dc.png" width="100px" height="100px;" id="img-logo"><div class="logo"><a id="a_logo" href="index.php?teamId=1" style="text-decoration:none; font-family:verdana;">
  			Heroes
  		</a></div>
		</header>
...
if ($result->num_rows > 0) {
  while($row3 = $result->fetch_assoc()) {
		...
		<div class="hero-container">
			<div class="hero-image"><img height="200px" width="130px;" src="images/<?php echo $row3["heroImage"]; ?>"></div>
       ...
       ?>
        <div class="top-part">
          <div class="mid-part-image">
            <img class="hero-image-round" height="200px" width="130px;" src="images/<?php echo $row3["heroImage"]; ?>">
          </div>
          <div class="info-box">
            <H1><?php echo $row3['heroName']?></H1>
            <h2>Info</h2>
            <p>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="frmRate">
              ...
              <div class="review">
                <h4>Review</h4>
                <textarea class="text-area" rows="4" cols="35" name="comment" form="usrform">
